...
//		e.printStackTrace();
	...
	public void cancelOrder() {
		...
		try {
			RestTemplate restTemplate = new RestTemplate();
			// res = restTemplate.exchange("https://mighty-plains-70341.herokuapp.com/cancelOrder/" + getOrderId(), HttpMethod.DELETE, httpEntityBean.getEntityFromUrl("https://mighty-plains-70341.herokuapp.com/cancelOrder/" + getOrderId()), new ParameterizedTypeReference<String>(){});//restTemplate.exchange(requestEntity, responseType)//
			//restTemplate.delete("https://mighty-plains-70341.herokuapp.com/cancelOrder/" + getOrderId());
			restTemplate.delete("https://mighty-plains-70341.herokuapp.com/cancelOrder/" + getOrderId());
	} catch (Throwable t) {
//		e.printStackTrace();
		//System.out.println(e.getResponseBodyAsString());
  ...
  //  restTemplate.setMessageConverters(messageConverters);  
			if (getOrderId() != null){
res = restTemplate.exchange("https://mighty-plains-70341.herokuapp.com/getOrder/" + getOrderId(), HttpMethod.GET, httpEntityBean.getEntityFromUrl("https://mighty-plains-70341.herokuapp.com/getOrder/" + getOrderId()), new ParameterizedTypeReference<String>(){});//restTemplate.exchange(requestEntity, responseType)//
	
			} else if (getActiveOrder().getId() != null){
				res = restTemplate.exchange("https://mighty-plains-70341.herokuapp.com/getOrder/" + getActiveOrder().getId(), HttpMethod.GET, httpEntityBean.getEntityFromUrl("https://mighty-plains-70341.herokuapp.com/getOrder/" + getActiveOrder().getId()), new ParameterizedTypeReference<String>(){});//restTemplate.exchange(requestEntity, responseType)//
...
//			order.setCancel_after("" + minutes + "," + hours + "," + days);
			...
			String url = "https://mighty-plains-70341.herokuapp.com/placeOrder";
...
//			RestTemplate restTemplate = new RestTemplate();
//			String url = "https://api.coinbasepro.com/orders";
////			 response;
////			try {
