 ...
 * 
 */
//document.domain='api.coinbasepro.com';
...
function ajaxCall() {
	request = $.ajax({
		//url: 'https://localhost:8080/testbackendrequest',//'https://api.coinbasepro.com/products',
		url: 'https://ancient-crag-48261.herokuapp.com/testbackendrequest',//'https://api.coinbasepro.com/products',
...
//			$('#counter').text('The current price of bitcoin is $' + result.price);
		...
		//$('#counter').text('Your current accounts on coinbasepro are' + JSON.stringify(result.price));
...
function statusCall() {
	request = $.ajax({
		//url: 'https://localhost:8080/testbackendrequest',//'https://api.coinbasepro.com/products',
		url: 'https://ancient-crag-48261.herokuapp.com/vitalityInstanceStatus',//'https://api.coinbasepro.com/products',
